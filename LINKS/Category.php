	...
	<body>
		...
		<?php
				...
				while($max>0)
			{
				...
				echo "<div class='col1'>
						<center><a href='ArtDetailsLoggedIn.php?Product_id=".$results[$max]['Product_id']."&Category_id=".$results[$max]['Category']."'><img src='../".$results[$max]['img_path']."' width='350' height='400'></a></center>
					  </div>
				";
				$max--;
			}
